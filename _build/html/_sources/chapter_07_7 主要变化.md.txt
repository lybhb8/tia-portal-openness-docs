...
该图中显示的对象模型已过时，有关 TIA Portal Openness V14 SP1 的对象模型信息，请[TIA Portal Openness 对象模型](#TIA-Portal-Openness-对象模型)”
